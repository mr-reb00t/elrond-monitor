...
LINE3:N3_TEMPRATING#33ff33:"Node3 Rating" \
GPRINT:N3_TEMPRATING:LAST:"Current\:%8.0lf"  \
GPRINT:N3_TEMPRATING:AVERAGE:"Average\:%8.0lf"  \
GPRINT:N3_TEMPRATING:MAX:"Maximum\:%8.0lf\n"
...
DEF:N3_LDR_SUCCESS=$RRD_LOCATION:N3_LDR_SUCCESS:AVERAGE \
DEF:N3_VALID_SUCCESS=$RRD_LOCATION:N3_VALID_SUCCESS:AVERAGE \
...
LINE3:N3_LDR_SUCCESS#33ff33:"Node3 Leader Success   " \
GPRINT:N3_LDR_SUCCESS:LAST:"Current\:%8.0lf\n"  \
COMMENT:" \n" \
...
LINE3:N3_VALID_SUCCESS#00ccff:"Node3 Validator Success" \
GPRINT:N3_VALID_SUCCESS:LAST:"Current\:%8.0lf\n" 
...
DEF:N3_LDR_FAIL=$RRD_LOCATION:N3_LDR_FAIL:AVERAGE \
DEF:N3_VALID_FAIL=$RRD_LOCATION:N3_VALID_FAIL:AVERAGE \
...
LINE3:N3_LDR_FAIL#33ff33:"Node3 Leader Failures   " \
GPRINT:N3_LDR_FAIL:LAST:"Current\:%8.0lf\n"  \
COMMENT:" \n" \
...
LINE3:N3_VALID_FAIL#00ccff:"Node3 Validator Failures" \
GPRINT:N3_VALID_FAIL:LAST:"Current\:%8.0lf\n" 
...
DEF:N3_VALID_IGNR_SIGN=$RRD_LOCATION:N3_VALID_IGNR_SIGN:AVERAGE \
...
LINE3:N3_VALID_IGNR_SIGN#33ff33:"Node3 Validator Ignored Signatures" \
GPRINT:N3_VALID_IGNR_SIGN:LAST:"Current\:%8.0lf\n" 
...
DEF:N3_TOTAL_LDR_SUCC=$RRD_LOCATION:N3_TOTAL_LDR_SUCC:AVERAGE \
...
LINE3:N3_TOTAL_LDR_SUCC#33ff33:"Node3 Total Leader Success" \
GPRINT:N3_TOTAL_LDR_SUCC:LAST:"Current\:%8.0lf\n" 
...
DEF:N3_TOTAL_VALID_SUCC=$RRD_LOCATION:N3_TOTAL_VALID_SUCC:AVERAGE \
...
LINE3:N3_TOTAL_VALID_SUCC#00ccff:"Node3 Total Validator Successes" \
GPRINT:N3_TOTAL_VALID_SUCC:LAST:"Current\:%8.0lf\n" 
...
DEF:N3_TOTAL_LDR_FAIL=$RRD_LOCATION:N3_TOTAL_LDR_FAIL:AVERAGE \
...
LINE3:N3_TOTAL_LDR_FAIL#33ff33:"Node3 Total Leader Failures" \
GPRINT:N3_TOTAL_LDR_FAIL:LAST:"Current\:%8.0lf\n" 
...
DEF:N3_TTL_VALID_FAIL=$RRD_LOCATION:N3_TTL_VALID_FAIL:AVERAGE \
...
LINE3:N3_TTL_VALID_FAIL#00ccff:"Node3 Total Validator Failures" \
GPRINT:N3_TTL_VALID_FAIL:LAST:"Current\:%8.0lf\n" 
...
DEF:N3_TTL_VLD_IGN_SIGN=$RRD_LOCATION:N3_TTL_VLD_IGN_SIGN:AVERAGE \
...
LINE3:N3_TTL_VLD_IGN_SIGN#00ccff:"Node3 Total Validator Ignored Signatures" \
GPRINT:N3_TTL_VLD_IGN_SIGN:LAST:"Current\:%8.0lf\n" 